    ...
    public function afficherFromEvenement($idEvenement=0,  $params=array())
    {
        ...
        */
        ...
        if ($authentification->estConnecte())
        {
            ...
            $html = "<div style='display:table;padding-top:50px;position:relative;'>".$tab->createHtmlDivsFromArray(array("styleDivs"=>"text-align:center;display:table;padding-left:5px;padding-bottom:5px;position:relative; width:130px;",  "nbColonnes"=>3,  "largeurLigne"=>500))."<div style='clear:both;'></div></div>";
        } else {
            //$html = "<div style='display:table;'>".$tab->createHtmlTableFromArray(3,  '',  '',  'align="center" valign="top" style="font-size:13px;"')."</div>";
            $html = "<div style='display:table;position:relative;'>".$tab->createHtmlDivsFromArray(array("styleDivs"=>"text-align:center;display:table;padding-left:5px;padding-bottom:5px;position:relative; width:130px;",  "nbColonnes"=>3,  "largeurLigne"=>500))."<div style='clear:left;'></div></div>";
        }
...
//    exit;
    ...
    public function afficherListe($criteres=array())
    {
        ...
        if ($nbEnregistrementTotaux>0)
        {
            ...
            while ($res =mysql_fetch_object($rep))
            {
                $t->assign_block_vars('image',  array(
    ...
    public function afficheHistoriqueImage($idImage=0)
    {
        ...
        if (isset($this->variablesGet['archiRetourIdValue']) && $this->variablesGet['archiRetourIdValue']!='') // en principe cette variable represente un idEvenement,  a changer pour l'id evenementGroupeAdresse
        {
            $adresse = new archiAdresse();
            $evenement = new archiEvenement();
            $idEvenementGroupeAdresse = $evenement->getIdEvenementGroupeAdresseFromIdEvenement($this->variablesGet['archiRetourIdValue']);
