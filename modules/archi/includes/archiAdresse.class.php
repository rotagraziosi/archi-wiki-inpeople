    ...
    * */
	...
	public function getArrayEncartAdressesImmeublesAvantApres($params = array())
	{
		...
		else
		{
			...
			$newWPetit = round(35*$w/100);
			$newHPetit = round(35*$h/100);
			$t->assign_vars(array('image2'=>"<div id='divImagePetit2' style='display:none;'><img src='".$this->getUrlImage()."imageDefautArchiv2.jpg' alt='' width=$newWPetit height=$newHPetit id='image2Petit'></div><div id='divImageGrand2' style='display:block;'><img src='".$this->getUrlImage()."imageDefautArchiv2.jpg' alt='' width=$newWGrand height=$newHGrand id='image2Grand'></div>"));
		}
	...
	public function getParcoursListe($params = array())
	{
		...
		// liste des parcours
		$html.="<h2>Liste des parcours proposés :</h2>";
