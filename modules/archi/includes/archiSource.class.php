...
class ArchiSource extends config
{
    ...
    /**
     * Constructeur de la classe archiSource
     * 
     * @return void
     * */
    ...
    /**
     * Affiche la liste des sources par ordre alphabétique
     * 
     * @param string $affichage      ?
     * @param string $lettreCourante Lettre actuelle
     * @param array  $tableauLettres Lettres
    ...
    {       
        ...
        case 'ajoutModifParcoursAdmin':
            ...
            if (isset($criteres['newIdSourceAdded']) && $criteres['newIdSourceAdded']!='0') {
                $t->assign_vars(
                    array('codeJavascriptReturnNewElementAjoute'=>"
    ...
    /**
     * Affiche l'image en taille originale
     * 
     * @param array $params Paramètres
     * 
     * @return string HTML
