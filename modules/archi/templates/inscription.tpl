...
<br>
	<div>
	<?_("L'inscription sur www.archi-strasbourg.com vous permet de contribuer au site en donnant des informations sur un immeuble, une adresse, en ajoutant des photos, ou en modifiant les articles existants. Vous pourrez aussi recevoir les nouvelles adresses par mail.")?>
	</div>
<br>
