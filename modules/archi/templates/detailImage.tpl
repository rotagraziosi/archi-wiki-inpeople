...
<!-- BEGIN previous -->
<a href="{prevURL}" class="prevPic" id="prevPic"><img src="images/Advisa/balise_inver.png" alt="Précédent"/></a>
<!-- END previous -->
...
<!-- BEGIN next -->
<a href="{nextURL}" class="nextPic" id="nextPic"><img src="images/Advisa/balise.png" alt="Suivant"/></a>
<!-- END next -->
<br/><br/>
