...
<!-- END hiddenFields -->
<!-- BEGIN fields -->
{fields.name}{fields.field}{fields.error}{codeHtmlBeforeSubmitButton}<input type='submit' value='{formButtonName}' name='valider' onclick="document.getElementById('msgFormulaireGenerator').innerHTML='Chargement en cours ';setTimeout('changeCurrentPoint()', 100);"><span id='msgFormulaireGenerator'></span><span id='points'></span>
<!-- END fields -->
</form></td></tr></table>