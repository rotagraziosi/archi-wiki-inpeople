...
<tr>
<td style='padding:0;margin:0;'  ><iframe src='{noSimple.isCarteGoogle.src}' id='iFrameGoogleMap' style='width:275px;height:275px;'  itemprop='map'></iframe><br>{noSimple.isCarteGoogle.lienVoirCarteGrand}{noSimple.isCarteGoogle.popupGoogleMap}</td>

<td style='padding-left:5px;padding-right:0px;margin:0;padding-top:0;padding-bottom:0;' >
<!-- END isCarteGoogle -->
<!-- BEGIN adresses -->
<table border="" class='tableauResumeAdresse' style='width:{largeurTableauResumeAdresse}px; height:{hauteurRecapAdresse}px;'>
...
<tr><td style='color:#000000;font-size:12px;'><li type='square' class="inside"><a href='{noSimple.choixEvenementSansTitre.url}'>{noSimple.choixEvenementSansTitre.titre}</a></li></td></tr>
