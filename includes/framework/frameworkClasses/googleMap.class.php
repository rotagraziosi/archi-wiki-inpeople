...
// 1.0 class permettant d'afficher une carte googleMap
...
class googleMap extends config
{
	...
	// meme fonction que la precedente , mais celle ci fonctionne a partir des coordonnees geographiques plutot que l'adresse
	// recuperation des coordonnées par une boucle sur la fonction addAdresse
...
acl.getManyElements=function(s){		
	...
	// ceci est utile quand on utilise pas la fonction load qui permet d'afficher une carte, ici on affiche pas de carte , on se sert juste de l'api googlemap
	...
	// meme fonction que la precedente mais permet de rapatrier plusieurs adresses
	...
	public function getMap($params = array())
	{
		...
		*/
		...
		else
		{
			...
			if(isset($params['idDivDisplayEtapesText']) && $params['idDivDisplayEtapesText']!='') // dans le cas d'un parcours de type 'walking' , a pied , il faut preciser le div avec l'affichage des informations du chemin, sinon le parcours ne s'affichera pas
			{
		...
		if(isset($params['listeCoordonnees']))
		{
			...
			foreach($params['listeCoordonnees'] as $indice => $values)
			{
				...
				{
					if($values['latitude']>47 && $values['latitude']<49 && $values['longitude']>7 && $values['longitude']<8) // verif pour que l'on reste a peu pres dans les coordonnees de la france ( verif a retirer si besoin)
					{
						if($i == 0)
						{
	...
	//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	private function deg2rad($deg=0) 
	{
		  return ($deg * pi() / 180.0);
	}
	...
	//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	private function rad2deg($rad=0) 
	{
		  return ($rad / pi() * 180.0);
	}
}
